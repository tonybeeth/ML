...
class DataSets(object):		
	def __init__(self,
		...
		#Randomly shuffle dataset to avoid training batches of with very similar images(https://www.quora.com/Does-the-order-of-training-data-matter-when-training-neural-networks)
